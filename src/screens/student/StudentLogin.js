import { View, Text, ImageBackground, Image, Dimensions, StyleSheet, TextInput } from 'react-native'
...
<TouchableOpacity activeOpacity={0.8} onPress={() => loginHandler()} style={{ height: 53,
    width: '40%',
    marginTop: 40,
    marginLeft:'50%',
    borderRadius: 30,
